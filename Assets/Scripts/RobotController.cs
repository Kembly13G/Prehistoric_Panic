...
public class RobotController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        currentState = isTargetInSightRange && isTargetInAttackRange ? PatrolStates.Attack : isTargetInSightRange && !isTargetInAttackRange ? PatrolStates.Chase : PatrolStates.Patrol;
        switch (currentState)
        {
